...
struct HardLevel: View {
    ...
    @State private var target = Int.random(in: 1...1000)
    ...
    var body: some View {
        NavigationView{
            Form{
                Section{
                Text("I'm thinking of a number between 1 and 1000. Guess What it is!")
                }
    ...
    func checkGuess(){
        ...
        guard givenInteger > 0, givenInteger < 1001
        else{
